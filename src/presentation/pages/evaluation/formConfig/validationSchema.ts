...
export const validationPsychologicalBasic = yup.object().shape({
  ...
  profecion:yup.string().required('La profesión es obligatoria'),
...
export const validationInfPsychologicalBasic = yup.object().shape({
  ...
  nombre: yup.string().required('El nombre es obligatorio'),
  ci: yup.string().required('El CI es obligatorio'),
  lugar_nacimiento:yup.string().required('El lugar de nacimiento es obligatorio'),
  fecha_nacimiento:yup.string().required('La fecha es obligatoria'),
  profecion:yup.string().required('La profesión es obligatoria'),
  domicilio:yup.string().required('El Domicilio es obligatorio'),
  numero_domicilio:yup.string().required('El número domicilio es obligatorio'),
  zona:yup.string().required('La zona es obligatoria'),
...
export const validationInfPsychological = yup.object().shape({
  ...
  profecion:yup.string().required('La profesión es obligatoria'),
  domicilio:yup.string().required('El Domicilio es obligatorio'),
  numero_domicilio:yup.string().required('El numero de domicilio es obligatorio'),
  zona:yup.string().required('La zona es obligatoria'),
  telefono:yup.string().required('El teléfono es obligatorio'),
  // B) HISTORIA MEDICA
