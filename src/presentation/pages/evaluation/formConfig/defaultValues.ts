...
export const defaultValuesInfPsychological:InfEvaluationPsychological ={
  ...
  resultado_recomendacion:'EL PACIENTE QUE SE ENCUENTRA EN EL MEDIO DE LA MADUREZ EMOCIONAL, Y ESO ES ALGO BASTANTE HABITUAL Y UN BUEN LUGAR PARA ESTAR, PUEDE PROCESAR SUS PROBLEMAS DE LA VIDA CON FACILIDAD  EN SITUACIONES DE ESTRÉS.',
  //F) OBSERVACIONES 
  observacion:'DEL PRESENTA APTO DE EVALUACION PSICOLOGICA DE ACUERDO A LOS RESULTADOS OBTENIDOS EN LAS PRUEBAS APLICADAS, CONCLUYO QUE EL INTERESADO NO PRESENTA ALTERACIONES FUNCIONALES SIGNIFICATIVAS O DISMINUIDAS EL PRESENTE OSTENTA CAPACIDADES ADECUADA POR LO QUE CONCLUYO,  ES "APTO PARA CONDUCIR VEHICULOS."',
}