...
export const temperaturas =[
                  ...
                  {label:'  36,3   ',value:'36,3'},
                  {label:'  36,4   ',value:'36,4'},
...
export const presionActerial =[
                ...
                {label:' 	130/90  ',value:'130/90'},
              ] 
export const presionRespiratoria =[
                {label:' 	19  ',value:'19'},
                {label:' 	20  ',value:'20'},
                {label:' 	21  ',value:'21'},
              ] 
export const presionCardiaca = [
  { label: '65', value: '65' },
  { label: '66', value: '66' },
  { label: '67', value: '67' },
  { label: '68', value: '68' },
...
export const resultados =[
                ...
                {label:' 	- NO ES APTO PARA CONDUCIR VEHICULOS INDICAR LOS MOTIVOS.  ',value:'NO ES APTO PARA CONDUCIR VEHICULOS INDICAR LOS MOTIVOS'},
